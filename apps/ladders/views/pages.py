from ladders.forms import LadderCreationForm
from ladders.logic.feeds import watched_ladder_feed, public_ladder_feed, nonfavorite_ladder_feed, favorite_ladder_feed
...
def ladder_feeds_page(request):
    return render(request, 'ladders/ladder_feeds_page.html', {'navbar_active': 'feeds', 'ladder_feed_size': 4,
...
def create_ladder_page(request):
    ...
    return render(request, 'ladders/create_ladder_page.html', {'form': form})
